...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(CodigoCategoriaNaoEncontrado.class)
    public ResponseEntity<?> codigoCategoriaNaoEncontrado(CodigoCategoriaNaoEncontrado ex, WebRequest request) {
